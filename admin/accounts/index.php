...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus" style="color: white;"></span>  Add New</a>
		</div>
	</div>
	<div class="card-body">
								...
								<?php 
									switch($row['status']){
										case 0:
											...
											break;
										case 1:
											echo '<span class="badge badge-primary bg-gradient-warning px-3 rounded-pill">Active</span>';
											break;
										default:
