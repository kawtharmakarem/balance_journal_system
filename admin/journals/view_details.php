...
<div class="container-fluid">
    <div id="outprint" class="list-group">
        <div class="row">
            ...
            <div class="col-4 bg-gradient-primary border">Remarks:</div>
