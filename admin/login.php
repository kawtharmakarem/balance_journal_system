  ...
  <div class="h-100 d-flex align-items-center w-100" id="login">
    ...
    <div class="col-5 h-100 bg-gradient">
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-md-12 col-md-6 col-lg-4 card-outline card-primary rounded-0 shadow" style="color:#736620;">
          ...
          <div class="card-body rounded-0">
            <form id="login-frm" action="" method="post">
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-4">
                  <button type="submit" class="btn btn-default  border-0 btn-block btn-flat"  style="background-color:#736620;color:white;">Sign In</button>
                </div>
                <!-- /.col -->
              </div>
            </form>
